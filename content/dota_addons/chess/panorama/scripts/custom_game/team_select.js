...
function OnTeamPlayerListChanged()
{
    ...
    var bUnassignedPlayers = Game.GetPlayerIDsOnTeam(DOTATeam_t.DOTA_TEAM_GOODGUYS).length + Game.GetPlayerIDsOnTeam(DOTATeam_t.DOTA_TEAM_BADGUYS).length === 0;
	$( "#GameAndPlayersRoot" ).SetHasClass( "unassigned_players", bUnassignedPlayers );
	$( "#GameAndPlayersRoot" ).SetHasClass( "no_unassigned_players", !bUnassignedPlayers );
}
